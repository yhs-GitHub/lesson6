...
public class GradeManager extends BaseService implements UserDetailsService {
    ...
    public void delGrade(Integer code) {
        gradeRepository.delete(code);
    }

    public Grade getGrade(Integer code) {
        return gradeRepository.findOne(code);
    }

    public void editGrade(Grade grade) {
        gradeRepository.update(grade.getCode(),grade.getName());
    }

    public Grade findOne(Integer code){
        return gradeRepository.findOne(code);
    }
}

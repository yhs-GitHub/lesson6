                        ...
                        <div class="col-xs-12">
                            ...
                            <form action="school/student/save_${cmd}.do" method="post" class="form-horizontal" role="form"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="gender" name="gender" maxlength="50" value="${student.gender}"
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-3">
                                       <%--<input type="text" data-date-format="yyyy-mm-dd" id="1_id" name="id" rowid="1" role="textbox" class="editable inline-edit-cell ui-widget-content ui-corner-all">
                                       <input type="text" name="startTime" data-date-format="yyyy-mm-dd" id="startTime">
                                       <input type="text" data-date-format="yyyy-mm-dd" id="1_sdate" name="sdate" rowid="1" role="textbox" class="editable inline-edit-cell ui-widget-content ui-corner-all" >--%>
                                       <input type="text" data-date-format="yyyy-mm-dd" id="birthday" name="birthday" value="${student.birthday}" role="textbox" >
                                      <%-- <input type="text" autocomplete="off" id="birthday" name="birthday" maxlength="50" value="${student.birthday}"
                                               class="required form-control"/>--%>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="cmd">
                                        <spring:message code="所在班级"/>
                                    </label>
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="cmd" name="cmd" value="${student.cmd}" maxlength="50" class=" form-control"/>
                                    </div>
                                </div>
